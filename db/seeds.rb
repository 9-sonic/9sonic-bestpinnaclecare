...
#
# Wipes existing table data and creates the initial required configuration and
# a single admin (manager) user account — nothing else.
...
# ---------------------------------------------------------------------------
# Admin User (Single Admin) — the only account created.
# ---------------------------------------------------------------------------
admin = Admin.create!(
...
puts "\n" + ("=" * 64)
puts "Seed complete. Cleaned DB and created 1 Admin."
puts "-" * 64
